...
function Payments() {
  const [paymentsData_page, setPaymentsData_page] = useState([
    { id: 1, payName: 'Kabir', amount: 100, date: '2023-09-16', paymentMode: 'Credit Card', hasMembership: true },
    { id: 2, payName: 'John', amount: 90, date: '2022-08-11', paymentMode: 'Cash', hasMembership: false },
  ]);
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.payName.trim() === '' || formData.amount.trim() === '' || formData.date.trim() === '') {
  ...
  return (
    <Container className="py-4">
      ...
      <h3 className="mt-4">Add a New Payment Mode</h3>
        ...
        <Row className="mb-3">
          <Col md={6}>
            <Form.Group>
              ...
              <Form.Control type="date" name="date" value={formData.date} onChange={handleChange_1} required />
            </Form.Group>
          </Col>
          <Col md={6}>
            <Form.Group>
        ...
        <Row className="mb-3">
          ...
          <Col md={6}>
            <Form.Group>
              ...
              <Button type="button" variant="danger" onClick={handleAbortPayment}>
                Abort Payment
              </Button>
            </Form.Group>
          </Col>
